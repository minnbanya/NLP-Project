...
def t5_model(temp = 0, rep = 1.5):
    model_id = '../NLP/NLP-Project/language_model/models/fastchat-t5-3b-v1.0/'
    # model_id = '../language_model/models/fastchat-t5-3b-v1.0/'
...
def gpt2_model(temp = 0, rep = 1.5):
    model_id = '../NLP/NLP-Project/language_model/models/gpt2-span-head-few-shot-k-16-finetuned-squad-seed-0/'
...
def flan_t5_model(temp = 0, rep = 1.5):
    model_id = '../NLP/NLP-Project/language_model/models/flan-t5-base/'
...
def flan_t5_large_model(temp = 0, rep = 1.5):
    model_id = '../NLP/NLP-Project/language_model/models/flan-t5-large/'
